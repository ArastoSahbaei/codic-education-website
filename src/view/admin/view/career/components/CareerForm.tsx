			...
			>
				<Form autoComplete='off'>
					<CareerWrapper>
						...
						<AdminInput name='title' label='Rubrik på annonsen' />
						<AdminInput name='jobType' label='Typ av tjänst' />
						<AdminInput name='location' label='Plats' />
						<AdminInput name='description' label='Beskrivning' type='textarea' />
