...
import { CareerAdminView } from 'view/admin/view/CareerAdminView'
import { EmployeeAdminView } from 'view/admin/view/EmployeeAdminView'
import { userAdminView } from 'view/admin/view/UserAdminView'
import { ProductAdminView }  from '../view/admin/view/ProductAdminView'
